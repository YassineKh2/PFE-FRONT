    ...
    <>
      <div className="w-full lg:w-[30%] bg-white rounded-xl border border-gray-300 p-6 flex flex-col gap-8 sticky top-20">
        ...
        <div className="flex flex-col gap-3">
          <Button onPress={EnrollCourse} color="primary">
            Enroll Now
          </Button>
        ...
        <div className="bg-gray-100 flex flex-col p-4 rounded-md text-sm gap-2">
          ...
          <div className="flex items-center gap-1 ">
            <Icon icon="iconoir:infinite" width="20" height="20" />
            <p>Lifetime access</p>
          </div>
          <div className="flex items-center gap-1 ">
            <Icon icon="flowbite:download-outline" width="20" height="20" />
            <p>Downloadable resources</p>
          </div>
          <div className="flex items-center gap-1 ">
            <Icon icon="tabler:certificate" width="20" height="20" />
            ...
            <ModalHeader className="flex flex-col gap-1">
              <div className="flex flex-col justify-center items-center ">
                <svg
                  ...
                  viewBox="0 0 20 20"
                >
                  <g fill="#519c4a" fillRule="evenodd" clipRule="evenodd">
                    <path
            ...
            <ModalFooter>
              <div className="flex flex-col justify-center items-center gap-3 w-full">
                ...
                <p className="text-center text-small">
                  You have an account?&nbsp;
                  <Link to="login" className="text-[#fc3c61]">
                    Login
                  </Link>
                </p>
              </div>
